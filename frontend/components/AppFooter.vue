<template>
  <footer>
    <section class="py-16 px-4 mt-auto flex flex-col lg:flex-row justify-around gap-4">
      <ul>
      ...
      <ul>
        <li><h2 class="mb-2">Support</h2></li>
      ...
      <ul>
        <li><h2 class="mb-2">Lorem</h2></li>
        <li><a href="#" class="link">Ipsum</a></li>
        <li><a href="#" class="link">Ipsum</a></li>
        <li><a href="#" class="link">Ipsum</a></li>
        <li><a href="#" class="link">Ipsum</a></li>
        <li><a href="#" class="link">Ipsum</a></li>
    ...
    <h2 class="font-semibold text-2xl text-center py-16">Saas © 2024</h2>
  </footer>
</template>
